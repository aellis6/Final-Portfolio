...
def links_section():
    ...
    st.sidebar.text("CC or Direct Email me :)")
    email_html=f'<a href="mailto:{info.my_email_address}"><img src="{info.email_image_url}" alt="Email" width = "75" height ="75"></a>'
    st.sidebar.markdown(email_html, unsafe_allow_html=True)
     
    st.sidebar.text("Call me (Business inquiries only)")
    st.sidebar.text("+1 678-727-6515") 
    #st.sidebar.markdown(linked_link, unsafe_allow_html=True)
links_section()
